 ...
 */
public class EntitledNamedCache extends WrapperNamedCache {
	/**
	 ...
	 */
	public class EntitledMapListener implements MapListener {
		// ----- constructors -------------------------------------------

		/**
		 * Construct an EntitledMapListener with the current subject. The
		 * subject will not be available in the security context when events are
		 * received by the proxy at runtime.
		 * 
		 * @param listener
		 *            the MapListener
		 */
