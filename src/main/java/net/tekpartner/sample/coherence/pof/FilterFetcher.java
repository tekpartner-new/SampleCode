 ...
 */
package net.tekpartner.sample.coherence.pof;
...
/**
 * FilterFetcher supports getting Filters or ValueExtractors by using an
 * InvocationService. See FilterFactory.
 * 
 * @author djl 2010.02.15
 */
public class FilterFetcher implements Invocable, PortableObject {
	// ----- constructors ---------------------------------------------------
	...
	/**
	 * Construct a new FilterFetcher that will return a Filter based on the
	 * given string
	 * 
	 * @param s
	...
	/**
	 * Construct a new FilterFetcher that will return a Filter based on the
	 * given string. The given flag controls whether a ValueExtractor or a
	 * Filter is retreived
	 * 
	 * @param s
	 *            The string that defines the Filter
	 * @param fFetchExtractor
	 *            a boolean flag that controls whether a ValueExtractor or a
	 *            Filter is retreived
	 **/
	...
	/**
	 * Construct a new FilterFetcher that will return a Filter based on the
	 * given string and binding environment.
	 * 
	 * @param s
	 *            The string that defines the Filter
	 * @param aEnv
	 ...
	 *            The string that defines the Filter
	 * @param bindings
	 *            a Map that specifies the binding environment
	 **/
	...
	/**
	 * Construct a new FilterFetcher that will return Filter based on the given
	 * string and binding environmets.
	 * 
	 * @param s
	 *            The string that defines the Filter
	 * @param aEnv
	...
	/**
	 * Called by the InvocationService exactly once on this Invocable object as
